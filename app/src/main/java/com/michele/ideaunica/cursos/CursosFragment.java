...
public class CursosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Refresh de la categoria de cursos
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //Vaciar el array listCategoriaCurso
                            listCategoriaCurso.clear();

                            //Obtncion de las categorias
                            ...
                            //Funcion al seleccionar redireccionar a una lista(recyclerview) de todos los curso de la categoria
