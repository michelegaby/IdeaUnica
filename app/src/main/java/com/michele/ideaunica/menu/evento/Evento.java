                                ...
                                if(!object.getString("whatsapp").equals("null")&& !object.getString("whatsapp").isEmpty()){
                                    ...
                                    whatsapp.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            Uri uri = Uri.parse("https://api.whatsapp.com/send?phone=" + what + "&text=Hola,%20vengo%20como%20referencia%20de%20la%20app%20IdeaUnica%20y%20quisiera%20consultar%20sobre%20un%20evento%20llamado%20'" +
                                                    titulo.getText().toString() + "'%20");
