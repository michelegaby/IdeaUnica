...
public class CumpleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //funcionalidad de floating Action Button
    ...
    private void GenerarDatos() {
        try {
            ...
            if(bd != null){
                ...
                //Limpiar la lista de los eventos
                listCumple.clear();

                //Recorere el resultado de la consulta
                ...
                //Funcionalidad al realizar una seleccion
            ...
            Toast.makeText(getContext(),"Error. Por favor intentelo mas tarde, gracias.",Toast.LENGTH_SHORT).show();
        }
    }
